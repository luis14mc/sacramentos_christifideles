      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold">Matrimonios</h1>
          </div>
          {permissions.canCreateSacramentos && (
            <Link href="/matrimonios/nuevo" className="btn btn-primary btn-sm">
        ...
        <div className="flex items-center gap-2">
          <div className="flex flex-1 items-center gap-2 rounded-lg border border-base-300 px-3 py-2">
            ...
            <input className="w-full bg-transparent text-sm outline-none" placeholder="Buscar por nombre de un contrayente…" value={nombre} onChange={(e) => setNombre(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && cargar(nombre)} />
          </div>
        ...
        <div className="overflow-x-auto rounded-lg border border-base-300">
          <table className="table">
            <thead>
              <tr>
                <th>Esposa</th><th>Esposo</th><th>Fecha</th><th>Libro</th><th>Página</th><th>Registro</th><th>Sacerdote</th><th className="text-right">Acciones</th>
              </tr>
            </thead>
            <tbody>
